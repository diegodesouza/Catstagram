...
feature "user creates meow for a post", %q{
  ...
  So that I can tell others that I like the post
   ...
   Acceptance Criteria
  [X] - I must be signed in to meow at a post
  [X] - I should see the current meow count
  [X] - When I meow, I should see the meow count go up
  [X] - I cannot Meow at the same Post twice
} do
